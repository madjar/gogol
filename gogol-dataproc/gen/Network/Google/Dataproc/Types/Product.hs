...
securityConfig
    :: SecurityConfig
securityConfig = SecurityConfig' {_scKerberosConfig = Nothing}
...
instance FromJSON SecurityConfig where
        parseJSON
          = withObject "SecurityConfig"
              (\ o -> SecurityConfig' <$> (o .:? "kerberosConfig"))
...
instanceReference =
  InstanceReference'
    {_irInstanceId = Nothing, _irPublicKey = Nothing, _irInstanceName = Nothing}
