...
--
-- /See:/ 'dimensionalityReductionMetrics' smart constructor.
newtype DimensionalityReductionMetrics =
  DimensionalityReductionMetrics'
    { _drmTotalExplainedVarianceRatio :: Maybe (Textual Double)
    }
  deriving (Eq, Show, Data, Typeable, Generic)
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'drmTotalExplainedVarianceRatio'
dimensionalityReductionMetrics
    :: DimensionalityReductionMetrics
dimensionalityReductionMetrics =
  DimensionalityReductionMetrics' {_drmTotalExplainedVarianceRatio = Nothing}


-- | Total percentage of variance explained by the selected principal
-- components.
drmTotalExplainedVarianceRatio :: Lens' DimensionalityReductionMetrics (Maybe Double)
drmTotalExplainedVarianceRatio
  = lens _drmTotalExplainedVarianceRatio
      (\ s a -> s{_drmTotalExplainedVarianceRatio = a})
      . mapping _Coerce

instance FromJSON DimensionalityReductionMetrics
         where
        parseJSON
          = withObject "DimensionalityReductionMetrics"
              (\ o ->
                 DimensionalityReductionMetrics' <$>
                   (o .:? "totalExplainedVarianceRatio"))

instance ToJSON DimensionalityReductionMetrics where
        toJSON DimensionalityReductionMetrics'{..}
          = object
              (catMaybes
                 [("totalExplainedVarianceRatio" .=) <$>
                    _drmTotalExplainedVarianceRatio])
...
data JobStatistics =
  JobStatistics'
    ...
    , _jsTransactionInfoTemplate :: !(Maybe TransactionInfo)
...
jobStatistics =
  JobStatistics'
    ...
    , _jsTransactionInfoTemplate = Nothing
...
jsTransactionInfoTemplate :: Lens' JobStatistics (Maybe TransactionInfo)
jsTransactionInfoTemplate
  = lens _jsTransactionInfoTemplate
      (\ s a -> s{_jsTransactionInfoTemplate = a})
...
-- training.
--
-- /See:/ 'globalExplanation' smart constructor.
data GlobalExplanation =
  GlobalExplanation'
    { _geClassLabel :: !(Maybe Text)
    , _geExplanations :: !(Maybe [Explanation])
    }
  deriving (Eq, Show, Data, Typeable, Generic)
...
globalExplanation
    :: GlobalExplanation
globalExplanation =
  GlobalExplanation' {_geClassLabel = Nothing, _geExplanations = Nothing}
...
-- descending order.
geClassLabel :: Lens' GlobalExplanation (Maybe Text)
geClassLabel
  = lens _geClassLabel (\ s a -> s{_geClassLabel = a})

-- | A list of the top global explanations. Sorted by absolute value of
-- attribution in descending order.
geExplanations :: Lens' GlobalExplanation [Explanation]
geExplanations
  = lens _geExplanations
      (\ s a -> s{_geExplanations = a})
      . _Default
      . _Coerce

instance FromJSON GlobalExplanation where
        parseJSON
          = withObject "GlobalExplanation"
              (\ o ->
                 GlobalExplanation' <$>
                   (o .:? "classLabel") <*>
                     (o .:? "explanations" .!= mempty))

instance ToJSON GlobalExplanation where
        toJSON GlobalExplanation'{..}
          = object
              (catMaybes
                 [("classLabel" .=) <$> _geClassLabel,
                  ("explanations" .=) <$> _geExplanations])
...
data Explanation =
  Explanation'
    { _eFeatureName :: !(Maybe Text)
    , _eAttribution :: !(Maybe (Textual Double))
    }
  deriving (Eq, Show, Data, Typeable, Generic)
...
explanation
    :: Explanation
explanation = Explanation' {_eFeatureName = Nothing, _eAttribution = Nothing}


-- | Full name of the feature. For non-numerical features, will be formatted
-- like .. Overall size of feature name will always be truncated to first
-- 120 characters.
eFeatureName :: Lens' Explanation (Maybe Text)
eFeatureName
  = lens _eFeatureName (\ s a -> s{_eFeatureName = a})

-- | Attribution of feature.
eAttribution :: Lens' Explanation (Maybe Double)
eAttribution
  = lens _eAttribution (\ s a -> s{_eAttribution = a})
      . mapping _Coerce
...
instance FromJSON Explanation where
        parseJSON
          = withObject "Explanation"
              (\ o ->
                 Explanation' <$>
                   (o .:? "featureName") <*> (o .:? "attribution"))

instance ToJSON Explanation where
        toJSON Explanation'{..}
          = object
              (catMaybes
                 [("featureName" .=) <$> _eFeatureName,
                  ("attribution" .=) <$> _eAttribution])
...
data IterationResult =
  IterationResult'
    ...
    , _irPrincipalComponentInfos :: !(Maybe [PrincipalComponentInfo])
...
iterationResult =
  IterationResult'
    ...
    , _irEvalLoss = Nothing
    , _irPrincipalComponentInfos = Nothing
...
irPrincipalComponentInfos :: Lens' IterationResult [PrincipalComponentInfo]
irPrincipalComponentInfos
  = lens _irPrincipalComponentInfos
      (\ s a -> s{_irPrincipalComponentInfos = a})
      . _Default
      . _Coerce
              ...
              (\ o ->
                 IterationResult' <$>
                   (o .:? "durationMs") <*> (o .:? "learnRate") <*>
                     ...
                     <*> (o .:? "evalLoss")
                     <*> (o .:? "principalComponentInfos" .!= mempty)
                     <*> (o .:? "trainingLoss")
                     <*> (o .:? "index"))
...
-- values are converted. This list and the precision and the scale
-- parameters of the decimal field determine the target type. In the order
-- of NUMERIC, BIGNUMERIC ([Preview](\/products\/#product-launch-stages)),
-- and STRING, a type is picked if it is in the specified list and if it
-- supports the precision and the scale. STRING supports all precision and
-- scale values. If none of the listed types supports the precision and the
...
-- data, an error will be thrown. Example: Suppose the value of this field
-- is [\"NUMERIC\", \"BIGNUMERIC\"]. If (precision,scale) is: * (38,9) ->
...
-- supported range). This field cannot contain duplicate types. The order
-- of the types in this field is ignored. For example, [\"BIGNUMERIC\",
-- \"NUMERIC\"] is the same as [\"NUMERIC\", \"BIGNUMERIC\"] and NUMERIC
-- always takes precedence over BIGNUMERIC. Defaults to [\"NUMERIC\",
...
data EvaluationMetrics =
  EvaluationMetrics'
    { _emDimensionalityReductionMetrics :: !(Maybe DimensionalityReductionMetrics)
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'emDimensionalityReductionMetrics'
--
-- * 'emClusteringMetrics'
--
-- * 'emRegressionMetrics'
...
evaluationMetrics =
  EvaluationMetrics'
    { _emDimensionalityReductionMetrics = Nothing
...
emDimensionalityReductionMetrics :: Lens' EvaluationMetrics (Maybe DimensionalityReductionMetrics)
emDimensionalityReductionMetrics
  = lens _emDimensionalityReductionMetrics
      (\ s a -> s{_emDimensionalityReductionMetrics = a})
...
instance FromJSON EvaluationMetrics where
        parseJSON
          = withObject "EvaluationMetrics"
              (\ o ->
                 EvaluationMetrics' <$>
                   (o .:? "dimensionalityReductionMetrics") <*>
                     (o .:? "clusteringMetrics")
                     <*> (o .:? "regressionMetrics")
...
instance ToJSON EvaluationMetrics where
        toJSON EvaluationMetrics'{..}
          = object
              (catMaybes
                 [("dimensionalityReductionMetrics" .=) <$>
                    _emDimensionalityReductionMetrics,
...
-- order.
--
-- /See:/ 'principalComponentInfo' smart constructor.
data PrincipalComponentInfo =
  PrincipalComponentInfo'
    { _pciCumulativeExplainedVarianceRatio :: !(Maybe (Textual Double))
    , _pciExplainedVarianceRatio :: !(Maybe (Textual Double))
    , _pciPrincipalComponentId :: !(Maybe (Textual Int64))
    , _pciExplainedVariance :: !(Maybe (Textual Double))
    }
  deriving (Eq, Show, Data, Typeable, Generic)
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'pciCumulativeExplainedVarianceRatio'
--
-- * 'pciExplainedVarianceRatio'
--
-- * 'pciPrincipalComponentId'
--
-- * 'pciExplainedVariance'
principalComponentInfo
    :: PrincipalComponentInfo
principalComponentInfo =
  PrincipalComponentInfo'
    { _pciCumulativeExplainedVarianceRatio = Nothing
    , _pciExplainedVarianceRatio = Nothing
    , _pciPrincipalComponentId = Nothing
    , _pciExplainedVariance = Nothing
    }


-- | The explained_variance is pre-ordered in the descending order to compute
-- the cumulative explained variance ratio.
pciCumulativeExplainedVarianceRatio :: Lens' PrincipalComponentInfo (Maybe Double)
pciCumulativeExplainedVarianceRatio
  = lens _pciCumulativeExplainedVarianceRatio
      (\ s a ->
         s{_pciCumulativeExplainedVarianceRatio = a})
      . mapping _Coerce

-- | Explained_variance over the total explained variance.
pciExplainedVarianceRatio :: Lens' PrincipalComponentInfo (Maybe Double)
pciExplainedVarianceRatio
  = lens _pciExplainedVarianceRatio
      (\ s a -> s{_pciExplainedVarianceRatio = a})
      . mapping _Coerce

-- | Id of the principal component.
pciPrincipalComponentId :: Lens' PrincipalComponentInfo (Maybe Int64)
pciPrincipalComponentId
  = lens _pciPrincipalComponentId
      (\ s a -> s{_pciPrincipalComponentId = a})
      . mapping _Coerce

-- | Explained variance by this principal component, which is simply the
-- eigenvalue.
pciExplainedVariance :: Lens' PrincipalComponentInfo (Maybe Double)
pciExplainedVariance
  = lens _pciExplainedVariance
      (\ s a -> s{_pciExplainedVariance = a})
      . mapping _Coerce

instance FromJSON PrincipalComponentInfo where
        parseJSON
          = withObject "PrincipalComponentInfo"
              (\ o ->
                 PrincipalComponentInfo' <$>
...
instance ToJSON PrincipalComponentInfo where
        toJSON PrincipalComponentInfo'{..}
          = object
              (catMaybes
                 [("cumulativeExplainedVarianceRatio" .=) <$>
                    _pciCumulativeExplainedVarianceRatio,
                  ("explainedVarianceRatio" .=) <$>
                    _pciExplainedVarianceRatio,
                  ("principalComponentId" .=) <$>
                    _pciPrincipalComponentId,
                  ("explainedVariance" .=) <$> _pciExplainedVariance])
...
-- TODO(b\/173344646) - Update return_type documentation to say it cannot
-- be set for TABLE_VALUED_FUNCTION before preview launch.
...
data TrainingRun =
  TrainingRun'
    ...
    , _trGlobalExplanations :: !(Maybe [GlobalExplanation])
    }
  deriving (Eq, Show, Data, Typeable, Generic)
...
trGlobalExplanations :: Lens' TrainingRun [GlobalExplanation]
trGlobalExplanations
  = lens _trGlobalExplanations
      (\ s a -> s{_trGlobalExplanations = a})
      . _Default
      . _Coerce
          ...
          = object
              (catMaybes
                 [("results" .=) <$> _trResults,
                  ...
                  ("globalExplanations" .=) <$> _trGlobalExplanations])
