...
--
-- /See:/ <http://developers.google.com/admin-sdk/ Admin SDK API Reference> for @directory.orgunits.get@.
module Network.Google.Resource.Directory.OrgUnits.Get
    (
    -- * REST Resource
      OrgUnitsGetResource
...
ougAllowPlus :: Lens' OrgUnitsGet (Maybe Bool)
ougAllowPlus
  = lens _ougAllowPlus (\ s a -> s{_ougAllowPlus = a})
