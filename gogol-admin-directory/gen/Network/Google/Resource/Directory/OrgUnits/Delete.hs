...
--
-- /See:/ <http://developers.google.com/admin-sdk/ Admin SDK API Reference> for @directory.orgunits.delete@.
module Network.Google.Resource.Directory.OrgUnits.Delete
    (
    -- * REST Resource
...
oudAllowPlus :: Lens' OrgUnitsDelete (Maybe Bool)
oudAllowPlus
  = lens _oudAllowPlus (\ s a -> s{_oudAllowPlus = a})
