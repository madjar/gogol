...
--
-- /See:/ <http://developers.google.com/admin-sdk/ Admin SDK API Reference> for @directory.orgunits.update@.
module Network.Google.Resource.Directory.OrgUnits.Update
    (
    -- * REST Resource
...
ouuAllowPlus :: Lens' OrgUnitsUpdate (Maybe Bool)
ouuAllowPlus
  = lens _ouuAllowPlus (\ s a -> s{_ouuAllowPlus = a})
