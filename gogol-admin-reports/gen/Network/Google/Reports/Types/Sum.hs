...
instance FromHttpApiData ActivitiesListApplicationName where
    parseQueryParam = \case
        "application_name_undefined" -> Right ApplicationNameUndefined
...
instance ToHttpApiData ActivitiesListApplicationName where
    toQueryParam = \case
        ApplicationNameUndefined -> "application_name_undefined"
...
instance FromHttpApiData EntityUsageReportsGetEntityType where
    parseQueryParam = \case
        "entity_type_undefined" -> Right EntityTypeUndefined
...
instance ToHttpApiData EntityUsageReportsGetEntityType where
    toQueryParam = \case
        EntityTypeUndefined -> "entity_type_undefined"
...
data ActivitiesWatchApplicationName
    = AWANApplicationNameUnspecified
...
instance FromHttpApiData ActivitiesWatchApplicationName where
    parseQueryParam = \case
        "application_name_unspecified" -> Right AWANApplicationNameUnspecified
...
instance ToHttpApiData ActivitiesWatchApplicationName where
    toQueryParam = \case
        AWANApplicationNameUnspecified -> "application_name_unspecified"
...
instance FromHttpApiData EntityUsageReportsGetEntityKey where
    parseQueryParam = \case
        "entityKeyUndefined" -> Right EntityKeyUndefined
        "all" -> Right All
...
instance ToHttpApiData EntityUsageReportsGetEntityKey where
    toQueryParam = \case
        EntityKeyUndefined -> "entityKeyUndefined"
        All -> "all"
        EntityKey -> "entityKey"
