...
-- Note: The only supported values for CPU are \'1\' and \'2\'. Cloud Run
...
-- | (Optional) Cloud Run fully managed: not supported Cloud Run for Anthos:
-- supported Number of seconds after which the probe times out. Defaults to
...
-- | (Optional) Cloud Run fully managed: Only memory and CPU are supported.
-- Note: The only supported values for CPU are \'1\', \'2\', and \'4\'.
-- Setting 4 CPU requires at least 2Gi of memory. Cloud Run for Anthos:
...
-- resource will be deleted. This field is set by the server when a
...
-- | (Optional) Cloud Run fully managed: not supported Cloud Run for Anthos:
-- supported List of objects that own this object. If ALL objects in the
...
-- ConfigMap\'s Data field will be presented in a volume as files using the
-- keys in the Data field as the file names, unless the items element is
...
-- | Specifies the generated logging url for this particular revision based
-- on the revision url template specified in the controller\'s config.
-- +optional
...
-- supported Arguments to the entrypoint. The docker image\'s CMD is used
...
-- | (Optional) Cloud Run fully managed: not supported Cloud Run for Anthos:
-- supported Image pull policy. One of Always, Never, IfNotPresent.
...
-- | (Optional) Cloud Run fully managed: not supported Cloud Run for Anthos:
-- supported Periodic probe of container service readiness. Container will
...
-- | (Optional) Cloud Run fully managed: not supported Cloud Run for Anthos:
-- supported Container\'s working directory. If not specified, the
...
-- | (Optional) Cloud Run fully managed: not supported Cloud Run for Anthos:
-- supported Command is the command line to execute inside the container,
...
-- | (Optional) Cloud Run fully managed: not supported Cloud Run for Anthos:
-- supported Path within the volume from which the container\'s volume
...
-- | (Optional) Cloud Run fully managed: not supported Cloud Run for Anthos:
-- supported An optional identifier to prepend to each key in the
...
-- | (Optional) Cloud Run fully managed: not supported Cloud Run for Anthos:
-- supported Mode bits to use on this file, must be a value between 0000
