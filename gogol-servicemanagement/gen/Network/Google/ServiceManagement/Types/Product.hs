...
-- | Required. The identity of consumer resource which service enablement
-- will be applied to. The Google Service Management implementation accepts
-- the following forms: - \"project:\" Note: this is made compatible with
