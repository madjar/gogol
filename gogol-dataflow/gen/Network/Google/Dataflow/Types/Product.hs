...
--
-- /See:/ 'createTemplateVersionRequest' smart constructor.
newtype CreateTemplateVersionRequest =
  CreateTemplateVersionRequest'
    { _ctvrTemplateVersion :: Maybe TemplateVersion
    }
  deriving (Eq, Show, Data, Typeable, Generic)


-- | Creates a value of 'CreateTemplateVersionRequest' with the minimum fields required to make a request.
--
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ctvrTemplateVersion'
createTemplateVersionRequest
    :: CreateTemplateVersionRequest
createTemplateVersionRequest =
  CreateTemplateVersionRequest' {_ctvrTemplateVersion = Nothing}


-- | The TemplateVersion object to create.
ctvrTemplateVersion :: Lens' CreateTemplateVersionRequest (Maybe TemplateVersion)
ctvrTemplateVersion
  = lens _ctvrTemplateVersion
      (\ s a -> s{_ctvrTemplateVersion = a})

instance FromJSON CreateTemplateVersionRequest where
        parseJSON
          = withObject "CreateTemplateVersionRequest"
              (\ o ->
                 CreateTemplateVersionRequest' <$>
                   (o .:? "templateVersion"))

instance ToJSON CreateTemplateVersionRequest where
        toJSON CreateTemplateVersionRequest'{..}
          = object
              (catMaybes
                 [("templateVersion" .=) <$> _ctvrTemplateVersion])
...
-- are \/\/\/\/ belong to the same Template. \/\/\/\/ Templates with the
-- same project_id belong to the same Project. \/\/\/\/ TemplateVersion may
-- have labels and multiple labels are allowed. \/\/\/\/ Duplicated labels
-- in the same \`TemplateVersion\` are not allowed. \/\/\/\/
-- TemplateVersion may have tags and multiple tags are allowed. Duplicated
-- \/\/\/\/ tags in the same \`Template\` are not allowed!
--
-- /See:/ 'templateVersion' smart constructor.
data TemplateVersion =
  TemplateVersion'
    { _tvVersionId :: !(Maybe Text)
    , _tvArtifact :: !(Maybe Artifact)
    , _tvDisplayName :: !(Maybe Text)
    , _tvLabels :: !(Maybe TemplateVersionLabels)
    , _tvProjectId :: !(Maybe Text)
    , _tvType :: !(Maybe TemplateVersionType)
...
-- | Creates a value of 'TemplateVersion' with the minimum fields required to make a request.
--
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'tvVersionId'
...
templateVersion =
  TemplateVersion'
    ...
    , _tvArtifact = Nothing
    , _tvDisplayName = Nothing
    , _tvLabels = Nothing
    , _tvProjectId = Nothing
    , _tvType = Nothing
...
tvVersionId :: Lens' TemplateVersion (Maybe Text)
tvVersionId
  = lens _tvVersionId (\ s a -> s{_tvVersionId = a})

-- | Job graph and metadata if it is a legacy Template. Container image path
-- and metadata if it is flex Template.
tvArtifact :: Lens' TemplateVersion (Maybe Artifact)
tvArtifact
  = lens _tvArtifact (\ s a -> s{_tvArtifact = a})

-- | A customized name for Template. Multiple TemplateVersions per Template.
tvDisplayName :: Lens' TemplateVersion (Maybe Text)
tvDisplayName
  = lens _tvDisplayName
      (\ s a -> s{_tvDisplayName = a})

-- | Labels for the Template Version. Labels can be duplicate within
-- Template.
tvLabels :: Lens' TemplateVersion (Maybe TemplateVersionLabels)
tvLabels = lens _tvLabels (\ s a -> s{_tvLabels = a})

-- | A unique project_id. Multiple Templates per Project.
tvProjectId :: Lens' TemplateVersion (Maybe Text)
tvProjectId
  = lens _tvProjectId (\ s a -> s{_tvProjectId = a})

-- | Either LEGACY or FLEX. This should match with the type of artifact.
tvType :: Lens' TemplateVersion (Maybe TemplateVersionType)
tvType = lens _tvType (\ s a -> s{_tvType = a})

-- | Template description from the user.
tvDescription :: Lens' TemplateVersion (Maybe Text)
tvDescription
  = lens _tvDescription
      (\ s a -> s{_tvDescription = a})

-- | Creation time of this TemplateVersion.
tvCreateTime :: Lens' TemplateVersion (Maybe UTCTime)
tvCreateTime
  = lens _tvCreateTime (\ s a -> s{_tvCreateTime = a})
      . mapping _DateTime

-- | Alias for version_id, helps locate a TemplateVersion.
tvTags :: Lens' TemplateVersion [Text]
tvTags
  = lens _tvTags (\ s a -> s{_tvTags = a}) . _Default .
      _Coerce

instance FromJSON TemplateVersion where
        parseJSON
          = withObject "TemplateVersion"
              (\ o ->
                 TemplateVersion' <$>
                   (o .:? "versionId") <*> (o .:? "artifact") <*>
                     (o .:? "displayName")
                     <*> (o .:? "labels")
                     <*> (o .:? "projectId")
                     <*> (o .:? "type")
...
instance ToJSON TemplateVersion where
        toJSON TemplateVersion'{..}
          = object
              (catMaybes
                 [("versionId" .=) <$> _tvVersionId,
                  ("artifact" .=) <$> _tvArtifact,
                  ("displayName" .=) <$> _tvDisplayName,
                  ("labels" .=) <$> _tvLabels,
                  ("projectId" .=) <$> _tvProjectId,
                  ("type" .=) <$> _tvType,
...
--
-- /See:/ 'commitTemplateVersionRequest' smart constructor.
newtype CommitTemplateVersionRequest =
  CommitTemplateVersionRequest'
    { _cTemplateVersion :: Maybe TemplateVersion
    }
  deriving (Eq, Show, Data, Typeable, Generic)


-- | Creates a value of 'CommitTemplateVersionRequest' with the minimum fields required to make a request.
--
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cTemplateVersion'
commitTemplateVersionRequest
    :: CommitTemplateVersionRequest
commitTemplateVersionRequest =
  CommitTemplateVersionRequest' {_cTemplateVersion = Nothing}


-- | TemplateVersion obejct to create.
cTemplateVersion :: Lens' CommitTemplateVersionRequest (Maybe TemplateVersion)
cTemplateVersion
  = lens _cTemplateVersion
      (\ s a -> s{_cTemplateVersion = a})

instance FromJSON CommitTemplateVersionRequest where
        parseJSON
          = withObject "CommitTemplateVersionRequest"
              (\ o ->
                 CommitTemplateVersionRequest' <$>
                   (o .:? "templateVersion"))

instance ToJSON CommitTemplateVersionRequest where
        toJSON CommitTemplateVersionRequest'{..}
          = object
              (catMaybes
                 [("templateVersion" .=) <$> _cTemplateVersion])
...
--
-- /See:/ 'modifyTemplateVersionLabelResponseLabels' smart constructor.
newtype ModifyTemplateVersionLabelResponseLabels =
  ModifyTemplateVersionLabelResponseLabels'
    { _mtvlrlAddtional :: HashMap Text Text
    }
  deriving (Eq, Show, Data, Typeable, Generic)


-- | Creates a value of 'ModifyTemplateVersionLabelResponseLabels' with the minimum fields required to make a request.
--
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mtvlrlAddtional'
modifyTemplateVersionLabelResponseLabels
    :: HashMap Text Text -- ^ 'mtvlrlAddtional'
    -> ModifyTemplateVersionLabelResponseLabels
modifyTemplateVersionLabelResponseLabels pMtvlrlAddtional_ =
  ModifyTemplateVersionLabelResponseLabels'
    {_mtvlrlAddtional = _Coerce # pMtvlrlAddtional_}


mtvlrlAddtional :: Lens' ModifyTemplateVersionLabelResponseLabels (HashMap Text Text)
mtvlrlAddtional
  = lens _mtvlrlAddtional
      (\ s a -> s{_mtvlrlAddtional = a})
      . _Coerce
...
instance ToJSON
           ModifyTemplateVersionLabelResponseLabels
         where
        toJSON = toJSON . _mtvlrlAddtional
...
-- TemplateVersion.
--
-- /See:/ 'modifyTemplateVersionLabelRequest' smart constructor.
data ModifyTemplateVersionLabelRequest =
  ModifyTemplateVersionLabelRequest'
    { _mtvlrOp :: !(Maybe ModifyTemplateVersionLabelRequestOp)
    , _mtvlrValue :: !(Maybe Text)
    , _mtvlrKey :: !(Maybe Text)
    }
  deriving (Eq, Show, Data, Typeable, Generic)


-- | Creates a value of 'ModifyTemplateVersionLabelRequest' with the minimum fields required to make a request.
--
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mtvlrOp'
...
modifyTemplateVersionLabelRequest =
  ModifyTemplateVersionLabelRequest'
    {_mtvlrOp = Nothing, _mtvlrValue = Nothing, _mtvlrKey = Nothing}


-- | Requests for add label to TemplateVersion or remove label from
-- TemplateVersion.
mtvlrOp :: Lens' ModifyTemplateVersionLabelRequest (Maybe ModifyTemplateVersionLabelRequestOp)
mtvlrOp = lens _mtvlrOp (\ s a -> s{_mtvlrOp = a})

-- | The label value for update.
mtvlrValue :: Lens' ModifyTemplateVersionLabelRequest (Maybe Text)
mtvlrValue
  = lens _mtvlrValue (\ s a -> s{_mtvlrValue = a})

-- | The label key for update.
mtvlrKey :: Lens' ModifyTemplateVersionLabelRequest (Maybe Text)
mtvlrKey = lens _mtvlrKey (\ s a -> s{_mtvlrKey = a})

instance FromJSON ModifyTemplateVersionLabelRequest
         where
        parseJSON
          = withObject "ModifyTemplateVersionLabelRequest"
              (\ o ->
                 ModifyTemplateVersionLabelRequest' <$>
                   (o .:? "op") <*> (o .:? "value") <*> (o .:? "key"))

instance ToJSON ModifyTemplateVersionLabelRequest
         where
        toJSON ModifyTemplateVersionLabelRequest'{..}
          = object
              (catMaybes
                 [("op" .=) <$> _mtvlrOp,
                  ("value" .=) <$> _mtvlrValue,
...
-- field for service related experiments is service_options. For more
...
-- always on). For more details see the rationale at
...
data Artifact =
  Artifact'
    { _aContainerSpec :: !(Maybe ContainerSpec)
    , _aJobGraphGcsPath :: !(Maybe Text)
    , _aMetadata :: !(Maybe TemplateMetadata)
    }
  deriving (Eq, Show, Data, Typeable, Generic)
...
artifact =
  Artifact'
    { _aContainerSpec = Nothing
    , _aJobGraphGcsPath = Nothing
    , _aMetadata = Nothing
    }


-- | Container image path set for flex Template.
aContainerSpec :: Lens' Artifact (Maybe ContainerSpec)
aContainerSpec
  = lens _aContainerSpec
      (\ s a -> s{_aContainerSpec = a})

-- | job_graph_gcs_path set for legacy Template.
aJobGraphGcsPath :: Lens' Artifact (Maybe Text)
aJobGraphGcsPath
  = lens _aJobGraphGcsPath
      (\ s a -> s{_aJobGraphGcsPath = a})

-- | Metadata set for legacy Template.
aMetadata :: Lens' Artifact (Maybe TemplateMetadata)
aMetadata
...
instance FromJSON Artifact where
        parseJSON
          = withObject "Artifact"
              (\ o ->
                 Artifact' <$>
                   (o .:? "containerSpec") <*> (o .:? "jobGraphGcsPath")
                     <*> (o .:? "metadata"))
...
instance ToJSON Artifact where
        toJSON Artifact'{..}
          = object
              (catMaybes
                 [("containerSpec" .=) <$> _aContainerSpec,
                  ("jobGraphGcsPath" .=) <$> _aJobGraphGcsPath,
                  ("metadata" .=) <$> _aMetadata])
...
-- current TemplateVersion. If remove_only set, remove the tag from the
-- current TemplateVersion.
--
-- /See:/ 'modifyTemplateVersionTagRequest' smart constructor.
data ModifyTemplateVersionTagRequest =
  ModifyTemplateVersionTagRequest'
    { _mtvtrTag :: !(Maybe Text)
    , _mtvtrRemoveOnly :: !(Maybe Bool)
    }
  deriving (Eq, Show, Data, Typeable, Generic)


-- | Creates a value of 'ModifyTemplateVersionTagRequest' with the minimum fields required to make a request.
--
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mtvtrTag'
...
modifyTemplateVersionTagRequest =
  ModifyTemplateVersionTagRequest'
    {_mtvtrTag = Nothing, _mtvtrRemoveOnly = Nothing}


-- | The tag for update.
mtvtrTag :: Lens' ModifyTemplateVersionTagRequest (Maybe Text)
mtvtrTag = lens _mtvtrTag (\ s a -> s{_mtvtrTag = a})

-- | The flag that indicates if the request is only for remove tag from
-- TemplateVersion.
mtvtrRemoveOnly :: Lens' ModifyTemplateVersionTagRequest (Maybe Bool)
mtvtrRemoveOnly
  = lens _mtvtrRemoveOnly
      (\ s a -> s{_mtvtrRemoveOnly = a})

instance FromJSON ModifyTemplateVersionTagRequest
         where
        parseJSON
          = withObject "ModifyTemplateVersionTagRequest"
              (\ o ->
                 ModifyTemplateVersionTagRequest' <$>
                   (o .:? "tag") <*> (o .:? "removeOnly"))

instance ToJSON ModifyTemplateVersionTagRequest where
        toJSON ModifyTemplateVersionTagRequest'{..}
          = object
              (catMaybes
                 [("tag" .=) <$> _mtvtrTag,
                  ("removeOnly" .=) <$> _mtvtrRemoveOnly])
...
--
-- /See:/ 'modifyTemplateVersionLabelResponse' smart constructor.
newtype ModifyTemplateVersionLabelResponse =
  ModifyTemplateVersionLabelResponse'
    { _mtvlrLabels :: Maybe ModifyTemplateVersionLabelResponseLabels
    }
  deriving (Eq, Show, Data, Typeable, Generic)


-- | Creates a value of 'ModifyTemplateVersionLabelResponse' with the minimum fields required to make a request.
--
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mtvlrLabels'
modifyTemplateVersionLabelResponse
    :: ModifyTemplateVersionLabelResponse
modifyTemplateVersionLabelResponse =
  ModifyTemplateVersionLabelResponse' {_mtvlrLabels = Nothing}


-- | All the label in the TemplateVersion.
mtvlrLabels :: Lens' ModifyTemplateVersionLabelResponse (Maybe ModifyTemplateVersionLabelResponseLabels)
mtvlrLabels
  = lens _mtvlrLabels (\ s a -> s{_mtvlrLabels = a})

instance FromJSON ModifyTemplateVersionLabelResponse
         where
        parseJSON
          = withObject "ModifyTemplateVersionLabelResponse"
              (\ o ->
                 ModifyTemplateVersionLabelResponse' <$>
                   (o .:? "labels"))

instance ToJSON ModifyTemplateVersionLabelResponse
         where
        toJSON ModifyTemplateVersionLabelResponse'{..}
          = object (catMaybes [("labels" .=) <$> _mtvlrLabels])
...
-- Template.
--
-- /See:/ 'templateVersionLabels' smart constructor.
newtype TemplateVersionLabels =
  TemplateVersionLabels'
    { _tvlAddtional :: HashMap Text Text
    }
  deriving (Eq, Show, Data, Typeable, Generic)


-- | Creates a value of 'TemplateVersionLabels' with the minimum fields required to make a request.
--
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'tvlAddtional'
templateVersionLabels
    :: HashMap Text Text -- ^ 'tvlAddtional'
    -> TemplateVersionLabels
templateVersionLabels pTvlAddtional_ =
  TemplateVersionLabels' {_tvlAddtional = _Coerce # pTvlAddtional_}


tvlAddtional :: Lens' TemplateVersionLabels (HashMap Text Text)
tvlAddtional
  = lens _tvlAddtional (\ s a -> s{_tvlAddtional = a})
      . _Coerce

instance FromJSON TemplateVersionLabels where
        parseJSON
          = withObject "TemplateVersionLabels"
              (\ o ->
                 TemplateVersionLabels' <$> (parseJSONObject o))

instance ToJSON TemplateVersionLabels where
        toJSON = toJSON . _tvlAddtional
...
data ListTemplateVersionsResponse =
  ListTemplateVersionsResponse'
    { _ltvrNextPageToken :: !(Maybe Text)
    , _ltvrTemplateVersions :: !(Maybe [TemplateVersion])
    }
  deriving (Eq, Show, Data, Typeable, Generic)
...
-- * 'ltvrNextPageToken'
--
-- * 'ltvrTemplateVersions'
listTemplateVersionsResponse
    :: ListTemplateVersionsResponse
listTemplateVersionsResponse =
  ListTemplateVersionsResponse'
    {_ltvrNextPageToken = Nothing, _ltvrTemplateVersions = Nothing}


-- | A token that can be sent as \`page_token\` to retrieve the next page. If
-- this field is omitted, there are no subsequent pages.
ltvrNextPageToken :: Lens' ListTemplateVersionsResponse (Maybe Text)
ltvrNextPageToken
  = lens _ltvrNextPageToken
      (\ s a -> s{_ltvrNextPageToken = a})

-- | A list of TemplateVersions.
ltvrTemplateVersions :: Lens' ListTemplateVersionsResponse [TemplateVersion]
ltvrTemplateVersions
  = lens _ltvrTemplateVersions
      (\ s a -> s{_ltvrTemplateVersions = a})
      . _Default
      . _Coerce

instance FromJSON ListTemplateVersionsResponse where
        parseJSON
          = withObject "ListTemplateVersionsResponse"
              (\ o ->
                 ListTemplateVersionsResponse' <$>
                   (o .:? "nextPageToken") <*>
                     (o .:? "templateVersions" .!= mempty))

instance ToJSON ListTemplateVersionsResponse where
        toJSON ListTemplateVersionsResponse'{..}
          = object
              (catMaybes
                 [("nextPageToken" .=) <$> _ltvrNextPageToken,
                  ("templateVersions" .=) <$> _ltvrTemplateVersions])
...
--
-- /See:/ 'modifyTemplateVersionTagResponse' smart constructor.
newtype ModifyTemplateVersionTagResponse =
  ModifyTemplateVersionTagResponse'
    { _mtvtrTags :: Maybe [Text]
    }
  deriving (Eq, Show, Data, Typeable, Generic)


-- | Creates a value of 'ModifyTemplateVersionTagResponse' with the minimum fields required to make a request.
--
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mtvtrTags'
modifyTemplateVersionTagResponse
    :: ModifyTemplateVersionTagResponse
modifyTemplateVersionTagResponse =
  ModifyTemplateVersionTagResponse' {_mtvtrTags = Nothing}


-- | All the tags in the TemplateVersion.
mtvtrTags :: Lens' ModifyTemplateVersionTagResponse [Text]
mtvtrTags
  = lens _mtvtrTags (\ s a -> s{_mtvtrTags = a}) .
      _Default
      . _Coerce

instance FromJSON ModifyTemplateVersionTagResponse
         where
        parseJSON
          = withObject "ModifyTemplateVersionTagResponse"
              (\ o ->
                 ModifyTemplateVersionTagResponse' <$>
                   (o .:? "tags" .!= mempty))

instance ToJSON ModifyTemplateVersionTagResponse
         where
        toJSON ModifyTemplateVersionTagResponse'{..}
          = object (catMaybes [("tags" .=) <$> _mtvtrTags])
