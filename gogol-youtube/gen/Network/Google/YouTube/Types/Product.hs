...
--
-- /See:/ 'videoRatingListResponse' smart constructor.
data VideoRatingListResponse =
  VideoRatingListResponse'
    { _vrlrEtag :: !(Maybe Text)
    , _vrlrKind :: !Text
    , _vrlrItems :: !(Maybe [VideoRating])
    , _vrlrVisitorId :: !(Maybe Text)
    , _vrlrEventId :: !(Maybe Text)
    }
  deriving (Eq, Show, Data, Typeable, Generic)


-- | Creates a value of 'VideoRatingListResponse' with the minimum fields required to make a request.
--
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'vrlrEtag'
...
videoRatingListResponse =
  VideoRatingListResponse'
    { _vrlrEtag = Nothing
    , _vrlrKind = "youtube#videoGetRatingResponse"
    , _vrlrItems = Nothing
    , _vrlrVisitorId = Nothing
    , _vrlrEventId = Nothing
    }


-- | Etag of this resource.
vrlrEtag :: Lens' VideoRatingListResponse (Maybe Text)
vrlrEtag = lens _vrlrEtag (\ s a -> s{_vrlrEtag = a})

-- | Identifies what kind of resource this is. Value: the fixed string
-- \"youtube#videoGetRatingResponse\".
vrlrKind :: Lens' VideoRatingListResponse Text
vrlrKind = lens _vrlrKind (\ s a -> s{_vrlrKind = a})

-- | A list of ratings that match the request criteria.
vrlrItems :: Lens' VideoRatingListResponse [VideoRating]
vrlrItems
  = lens _vrlrItems (\ s a -> s{_vrlrItems = a}) .
      _Default
      . _Coerce

-- | The visitorId identifies the visitor.
vrlrVisitorId :: Lens' VideoRatingListResponse (Maybe Text)
vrlrVisitorId
  = lens _vrlrVisitorId
      (\ s a -> s{_vrlrVisitorId = a})

-- | Serialized EventId of the request which produced this response.
vrlrEventId :: Lens' VideoRatingListResponse (Maybe Text)
vrlrEventId
  = lens _vrlrEventId (\ s a -> s{_vrlrEventId = a})

instance FromJSON VideoRatingListResponse where
        parseJSON
          = withObject "VideoRatingListResponse"
              (\ o ->
                 VideoRatingListResponse' <$>
                   (o .:? "etag") <*>
...
instance ToJSON VideoRatingListResponse where
        toJSON VideoRatingListResponse'{..}
          = object
              (catMaybes
                 [("etag" .=) <$> _vrlrEtag,
                  Just ("kind" .= _vrlrKind),
                  ("items" .=) <$> _vrlrItems,
                  ("visitorId" .=) <$> _vrlrVisitorId,
                  ("eventId" .=) <$> _vrlrEventId])
...
testItem
    :: TestItem
testItem = TestItem' {_tiSnippet = Nothing, _tiGaia = Nothing, _tiId = Nothing}
