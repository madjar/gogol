...
data GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata =
  GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata'
    ...
    , _gcsmpvsmEligibility :: !(Maybe GoogleCloudSaasacceleratorManagementProvidersV1SloEligibility)
...
-- | Optional. Global per-instance SLI eligibility which applies to all
-- defined SLIs. Exactly one of \'eligibility\' and \'per_sli_eligibility\'
-- fields must be used.
gcsmpvsmEligibility :: Lens' GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata (Maybe GoogleCloudSaasacceleratorManagementProvidersV1SloEligibility)
gcsmpvsmEligibility
  = lens _gcsmpvsmEligibility
      (\ s a -> s{_gcsmpvsmEligibility = a})
          ...
          = object
              (catMaybes
                 [("perSliEligibility" .=) <$>
                  ...
                  ("tier" .=) <$> _gcsmpvsmTier,
                  ("eligibility" .=) <$> _gcsmpvsmEligibility,
