...
-- | See and add info about your body measurements and heart rate to Google
-- Fit
...
-- | See and add info about your oxygen saturation in Google Fit. I consent
-- to Google sharing my oxygen saturation information with this app.
