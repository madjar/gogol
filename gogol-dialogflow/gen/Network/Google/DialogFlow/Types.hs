...
module Network.Google.DialogFlow.Types
    ...
    , googleCloudDialogflowCxV3beta1Fulfillment
    , gcdcvfcTag
    , gcdcvfcConditionalCases
    , gcdcvfcMessages
    , gcdcvfcWebhook
    , gcdcvfcSetParameterActions
...
dialogFlowService
  = defaultService (ServiceId "dialogflow:v3")
