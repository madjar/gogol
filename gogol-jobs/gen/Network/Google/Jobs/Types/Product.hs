...
-- histogram by the Job.posting_publish_time in months. Must specify list
-- of numeric buckets in spec. * publish_time_in_year: histogram by the
...
-- expression. The expression must be \< 6000 bytes in length. Sample
